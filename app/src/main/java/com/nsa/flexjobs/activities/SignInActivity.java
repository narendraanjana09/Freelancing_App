...
import com.nsa.flexjobs.Model.BalanceModel;
import com.nsa.flexjobs.Model.UserModel;
import com.nsa.flexjobs.R;
import com.nsa.flexjobs.email.Config;
...
public class SignInActivity extends AppCompatActivity {
    ...
    private void getReferralLink() {
        ...
        DynamicLink dynamicLink = FirebaseDynamicLinks.getInstance().createDynamicLink()
                .setLink(Uri.parse("https://www.flexjobs.com/?type=referral&by="+firebaseUser.getUid()))
                .setDomainUriPrefix("https://flexjobs.page.link")
        ...
        pwdED.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if(pwd.isEmpty()){
                    ...
                    if(pwd.length()<8){
                        pwdED.setTextColor(getResources().getColor(R.color.black));
                    }else{
                        pwdED.setTextColor(getResources().getColor(R.color.chocalte));
                    }
    ...
    private void setEmailListener() {
        emailSignUpED.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
               email=s.toString();
               if(checkEmail(email)){
                   emailSignUpED.setTextColor(getResources().getColor(R.color.chocalte));
               }else{
                   emailSignUpED.setTextColor(getResources().getColor(R.color.black));
               }
            }
        });
    }
