...
import com.nsa.flexjobs.Model.FormatModel;
import com.nsa.flexjobs.R;


public class MainLabelView {
    Context context;
    RelativeLayout relativeLayout;


    public MainLabelView(Context context, RelativeLayout frameLayout) {
        this.context = context;
        this.relativeLayout =frameLayout;

    }
    public  void addText(String text,int color){
      View view= LayoutInflater.from(context).inflate(R.layout.main_label_layout,null,true);
    ...
    private void setupView(View view, String text, int color) {
        ...
        MainAnnotateActivity.imgDrag=imgDrag;


        ImageView imgRect=view.findViewById(R.id.imgPhotoEditorRect);


        MainAnnotateActivity.currentModel=new FormatModel(text,
    ...
    public void removeView(View view){
        MainAnnotateActivity.added_view=null;
                relativeLayout.removeView(view);
    }

    private void addView(View view) {
        MainAnnotateActivity.added_view=view;
