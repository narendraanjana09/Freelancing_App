...
import com.nsa.labelimages.Extra.Aadhar;
...
import com.nsa.labelimages.Model.IDModel;
...
import static com.nsa.labelimages.Extra.BalloonText.getBalloon;
    ...
    public void verifyCode(){
        ...
        verifyBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ProfileActivity.this, CODE+","+otpTextView.getOTP(), Toast.LENGTH_SHORT).show();
