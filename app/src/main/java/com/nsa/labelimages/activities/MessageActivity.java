...
import static com.nsa.labelimages.activities.TaskActivity.currentChatAddress;
...
import com.nsa.labelimages.Message.APIService;
import com.nsa.labelimages.Message.Chat;
import com.nsa.labelimages.Message.Client;
import com.nsa.labelimages.Message.Data;
import com.nsa.labelimages.Message.MessageAdapter;
import com.nsa.labelimages.Message.MyResponse;
import com.nsa.labelimages.Message.SendNotification;
import com.nsa.labelimages.Message.Sender;
...
public class MessageActivity extends AppCompatActivity {
    ...
    private void checkSeen(){
       for(Pair<String,List<Chat>> pair:chatsList){
           if(pair.first.equals(currentChatAddress)){

               Log.e("TAG", ""+pair.second.get(pair.second.size()-1).getMessage());
